  ...
  <div class="container mt-5">
    ...
    <form action="movimentacoes_registrar.php" method="POST">
      ...
      <div class="mb-3">
        ...
        <input type="datetime-local" class="form-control" name="data_movimentacao" required />
      </div>

      <div class="mb-3">
        <label class="form-label">Observação</label>
        <input type="text" class="form-control" name="observacao" placeholder="Digite uma observação, se necessário" />
      </div>
